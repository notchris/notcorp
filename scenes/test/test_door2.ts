...
export default class TestDoor2 extends Phaser.Scene {
  ...
  create(): void {
    ...
    const testItem = new Item(this, 40, 100, null, 0, 1);
    const testDoor = new Door(this, 90, 40, null, 0, true, testItem);
